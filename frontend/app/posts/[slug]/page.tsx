    ...
    <>
      <div className="">
        <div className="container my-12 lg:my-24 grid gap-12">
          <div>
            <div className="pb-6 grid gap-6 mb-6 border-b border-dark/10">
              <div className="max-w-3xl flex flex-col gap-6">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl">{post.title}</h1>
              </div>
      ...
      <div className="border-t border-dark/10 bg-light">
